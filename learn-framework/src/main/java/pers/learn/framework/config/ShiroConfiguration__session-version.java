...
//import pers.learn.framework.shiro.web.token.basicAuthenticationFilter;
//import pers.learn.framework.shiro.web.token.BearerAuthenticationFilter;
//import pers.learn.framework.shiro.web.session.SessionManager;
//
//@Configuration
//public class ShiroConfiguration__ {
//
//    /**
...
//        // 使用token持久化过滤器
//        filters.put("authcBasic", getAuthBasicFilter());
//        filters.put("authcBearer", getAuthBearerFilter());
//        shiroFilterFactoryBean.setFilters(filters);
//
//        return shiroFilterFactoryBean;
//    }
//
//    public BearerAuthenticationFilter getAuthBearerFilter() {
//        BearerAuthenticationFilter filter = new BearerAuthenticationFilter();
//        return filter;
//    }
//
//    public basicAuthenticationFilter getAuthBasicFilter() {
...
//        // 其他所有资源都需要授权才能访问
////        filterChainDefinitionMap.put("/**", "user,dbSession,syncDbSession");  // 这个是使用session的
//        filterChainDefinitionMap.put("/**", "authc,authcBasic,authcBearer"); // 这个是使用Bearer的
//
